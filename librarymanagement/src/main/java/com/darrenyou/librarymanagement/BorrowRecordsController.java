...
public class BorrowRecordsController {
    ...
    @CrossOrigin(origins = "*")
    public ResponseEntity<BorrowRecords> insertBorrowRecord(@RequestParam int userId, @RequestParam int bookId, @RequestParam int inventoryId) {
        BorrowRecords newBorrowRecord = borrowRecordsService.insertBorrowRecord(userId, bookId, inventoryId);
